...
set(BUILD_SPEC_FILE "${CMAKE_CURRENT_SOURCE_DIR}/buildspec.json" CACHE FILEPATH "Build specification file")
if(NOT IS_ABSOLUTE "${BUILD_SPEC_FILE}")
  cmake_path(ABSOLUTE_PATH BUILD_SPEC_FILE BASE_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}" NORMALIZE)
endif()
file(READ "${BUILD_SPEC_FILE}" buildspec)
...
string(REGEX MATCH "^[0-9]+\\.[0-9]+\\.[0-9]+" _version_canonical "${_version}")
if(NOT _version_canonical)
  message(FATAL_ERROR "Invalid semantic version in ${BUILD_SPEC_FILE}: ${_version}")
endif()
set(_version "${_version_canonical}")
string(REPLACE "." ";" _version_canonical "${_version_canonical}")
